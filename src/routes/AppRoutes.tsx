...
import ClasificarImagenes from "../pages/Clasificar/ClasificarImagenes";
import ClasificarAudios from "../pages/Clasificar/ClasificarAudios";
import ClasificarPosturas from "../pages/Clasificar/ClasificarPosturas";
