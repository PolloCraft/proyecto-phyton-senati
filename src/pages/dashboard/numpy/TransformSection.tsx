  ...
  return (
    <div style={{ marginBottom: "20px" }}>
      ...
      <div style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
        ...
        <select value={transform} onChange={(e) => onTransformChange(e.target.value)} style={{ padding: "10px 14px", borderRadius: "6px", fontSize: "14px" }}>
        ...
        {["add", "subtract", "multiply", "divide"].includes(transform) && (
          <input type="number" value={scalar} onChange={(e) => onScalarChange(e.target.value)} style={{ padding: "10px 14px", borderRadius: "6px", fontSize: "14px", width: "80px" }} />
        )}
