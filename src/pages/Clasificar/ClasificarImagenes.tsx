  ...
  return (
    <section className="page">
      <div className="page-inner">
        <SectionTitle subtitle="Clasifica imagenes en tiempo real con IA">
          Clasificar Imagenes
        </SectionTitle>

        <div className="tm-container">
          <h3 className="tm-title">Teachable Machine Image Model</h3>
...
export default ClasificarImagenes;
